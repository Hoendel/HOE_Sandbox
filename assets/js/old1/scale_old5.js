(function () {
  /* Bereich so wählen, dass der DEFAULT genau in der Mitte liegt
     (gutes Gefühl auf dem Slider):
     MIN=0.90  MAX=1.50  -> Mitte = 1.20 (Default)
  */
  ...
  function buildBar() {
    ...
    // kleines Pad oben, damit die Bar optisch nicht „klebt“
    const pad = document.createElement("div");
    pad.className = "scale-ctrl-pad";
    bar.appendChild(pad);
