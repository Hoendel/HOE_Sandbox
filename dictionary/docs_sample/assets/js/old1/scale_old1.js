(function () {
  ...
  function mountWhenReady() {
    // Material-Header finden, wenn gerendert
    const target = document.querySelector(".md-header__inner");
    if (target) { buildControl(target); return; }
    // Falls noch nicht verfügbar (bei SPA-Navigation), später erneut versuchen
    setTimeout(mountWhenReady, 120);
  }

  // Initial + bei Material-Spa-Contentwechsel
